...
botonAll.forEach(button=> {
    ...
    operacion = document.getElementById(botonAll).textContent;

    console.log("Se hizo clic en el botón:", document.getElementById(botonAll).textContent);

    if(operacion = "Suma"){
        suma;
    }else if(operacion = "Resta"){
        resta;
    }else if(operacion = "Multiplicaciòn"){
        multiplica;
